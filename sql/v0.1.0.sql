...
create table user (
  ...
  plan tinyint(1) not null default 0 comment '会员等级',
...
insert into user (id,affiliate,referral,plan,nickname,status,facebook,update_time) values (1,'888888','888888',0,'ezd',1,'{"name": "Vivian Lim","id": "123805028625200"}',now());
