...
create table quota (
  ...
  chain_father int unsigned not null default 0 comment 'nearest partner or super',
  chain_father_plan tinyint(1) not null default 0,
  chain_father_earning int not null default 0 comment 'partner:floor(budget*0.15);super:floor(budget*0.2)',
  chain_grandpa int unsigned not null default 0 comment 'secondary nearest partner or super only when chain_father_plan is partner',
  chain_grandpa_plan tinyint(1) not null default 0,
  chain_grandpa_earning int not null default 0 comment 'floor(budget*0.05)',
  super int not null default 0,
  super_earning int not null default 0 comment 'super!=0:floor(budget*0.05);others:0',
  margin int not null default 0 comment 'budget-buyer_earning-father_earning-grandpa_earning-chain_father_earning-chain_grandpa_earning-super_earning',
  primary key (id)
