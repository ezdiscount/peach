...
insert into user_plan (level,name,description) values (0,'member','普通会员'),(1,'vip','付费会员'),(2,'partner','梦想合伙人'),(3,'super','超级合伙人');
...
# 5% 平级奖
#   仅一个超级合伙人A，发展出了另外一个超级合伙人B，并且B没有发展任何超级合伙人，则A获取5%的平级奖
# 5% 结余
################################################################################
